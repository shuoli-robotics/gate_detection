function [gate_corners_x, gate_corners_y] = run_detection_on_img_lc(dir_name, frame_nr)
close all;
graphics = true;
...
if(SUB_SAMPLING_SNAKE)
    ...
    for g = 1:n_gates
        ...
        if(method == INDIRECT)
            ...
            [gate_corners_x,gate_corners_y,xx, yy, ss, best_fit, valid, height_left, height_right, angle, angle_1, angle_2] = fit_window_to_points_free_lc(points, x(g) - x_l, y(g) - y_l, s(g), weights, Response);
